...
from orbl_onpremise import constants
from orbl_onpremise.auth_token import AuthorizationTokenAuth
from orbl_onpremise.utils import cached_property, get_package_version
...
class Catcher:
    ...
    def __call__(self, *args: list, **kwargs: dict) -> Any:
        ...
        module_path = f"orbl_onpremise.{path}.v{self.api_version}"
...
class Client:
    ...
    def common_headers(self) -> dict:
        root = "orbl-onpremise-python"
        if self.is_async:
            root = "orbl-onpremise-python-async"
